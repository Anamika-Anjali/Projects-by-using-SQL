...
-- The manager asked the emoloyee How many cars will be avilable in 2023? --
...
select count(*) from car_dekho where year = 2020 and fuel = "Diesel" ; # 20
 ...
 -- The manager told the employee to give a give a print All the fuel cars ( petrol,diesel, and CNG) come by all year. --
